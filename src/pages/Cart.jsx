      ...
      <div style={{marginTop:'150px'}} className="container">
                        ...
                        ourCart?.map((product,index)=>(
                          ...
                          <td>
                            <div className="d-flex">
                              ...
                              <input type="text" value={product?.quantity} style={{ width:'50px'}} className='fw-bolder me-1 ms-1' readOnly />
        ...
        :
          <div style={{height:'60vh'}} className="d-flex justify-content-center align-items-center flex-column ">
            <img src="https://static.vecteezy.com/system/resources/previews/008/515/488/large_2x/empty-cart-flat-illustration-concept-vector.jpg" width={'400px'} height={'400px'} alt="empty" />
